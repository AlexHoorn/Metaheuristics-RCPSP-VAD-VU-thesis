...
from eaplanner.algorithms.ga import MuPlusLambda
...
parser.add_argument("--lambda_", type=int, default=LAMBDA_, help="Number of offspring")
parser.add_argument("--cxpb", type=float, default=CXPB, help="Crossover probability")
parser.add_argument("--cx_indpb", type=float, default=CX_INDPB, help="Crossover indpb")
parser.add_argument("--mut_indpb", type=float, default=MUT_INDPB, help="Mutation indpb")
parser.add_argument("--mut_mu", type=float, default=MUT_MU, help="Mutation mu")
...
# toolbox.decorate("mutate", check_individual)
...
if __name__ == "__main__":
    ...
    if sys.gettrace() is None and not args.disable_multiprocessing:
        toolbox.register("map", ThreadPool().map)
